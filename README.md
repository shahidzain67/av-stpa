...
The aim of this project is to develop a base set of safety requirements that will be widely applicable to autonomous vehicles.
...
**All work here is Work In Progress, and is published on an "AS IS" BASIS, WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.**
